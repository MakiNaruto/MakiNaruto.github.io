---
layout: post
title: "Stanford / Winter 2020 CS224n 课程学习笔记03-04"
subtitle: "Assignment"
author: "MakiNaruto"
...
![图 1](https://upload-images.jianshu.io/upload_images/17373898-5d2e8bd54b2fecd1.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

为了解决这个问题，Word-Window classification分类方法被提出，主要思想是从中心词附近的单词来进行判断，中心词是不是实体。和Skip-grim算法相似，也有一个窗口。

## Word-Window classification

在进行分类训练时，上一课训练的词向量在这里派上用场了。假设现在中心词为Paris，窗口为5，每个词的词向量维度为$ \mathbb{R}^{1 \times 4} $，将一个窗口内所有的单词进行拼接后，得到拼接矩阵$x \in \mathbb{R}^{1 \times 20}$作为训练输入。

![图 2  对Paris进行分类](https://upload-images.jianshu.io/upload_images/17373898-49300dd916b8ba2a.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![图 3 一个简单的三层神经网络示意图](https://upload-images.jianshu.io/upload_images/17373898-187c616103e3c3f7.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![图 4  Neural Network](https://upload-images.jianshu.io/upload_images/17373898-1d795173d7d6c486.gif?imageMogr2/auto-orient/strip)
...
![简化的神经网络图](https://upload-images.jianshu.io/upload_images/17373898-156024c995f0ddbb.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
